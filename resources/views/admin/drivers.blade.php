        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                    <thead>
                    <tr role="row">
                        <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 142.133px;" aria-sort="ascending">Nom</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 158.283px;" >Prénom</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 135.017px;" >Travail chez</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 118.467px;" >Numéro de téléphone</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 118.467px;" >Rendement</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 98.7667px;" >Actions</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr role="row" class="odd">
                        <td class="sorting_1">OUKACHA</td>
                        <td>Fouzi</td>
                        <td>Win 98+ / OSX.2+</td>
                        <td>1.7</td>
                    ...
                    <tfoot>
                        <tr><th rowspan="1" colspan="1">Modèle</th>
                            ...
                            <th rowspan="1" colspan="1">Rendement</th>
